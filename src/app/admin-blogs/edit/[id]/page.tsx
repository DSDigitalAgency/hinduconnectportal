...
export default function EditBlogPage() {
  ...
  const fetchBlog = async () => {
    try {
      ...
      setBlog(data);
      setTitle(data.basicInfo?.title || "");
      setAuthorName(data.author?.authorName || "");
      setStatus(data.basicInfo?.status || "draft");
      setCategory(data.basicInfo?.category || "General");
    ...
    <div className="p-4 sm:p-8 bg-[#fff7ed] min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-extrabold text-orange-600 tracking-tight">Edit Blog</h1>
          <button
            onClick={() => router.push('/admin-blogs')}
